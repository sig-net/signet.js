# Signet.js Quick Start

A TypeScript library for handling interactions with Sig Network MPC and Smart Contracts

## Supported Chains

- [EVM Chains](/api-reference/evm.mdx) - Ethereum and compatible networks
- [Bitcoin](/api-reference/btc.mdx) - Bitcoin network
- [Cosmos Chains](/api-reference/cosmos.mdx) - Cosmos SDK-based networks
...
For more details check the [Chain](/primitives/chain-interfaces.mdx) page.
