...
### Assumptions
- The `ChainSignatures` contract is deployed on Sepolia at `0x69C6b28Fdc74618817fa380De29a653060e14009`.
- You have a configured `viem` walletClient and publicClient pointing to the Sepolia testnet.
...
// Key version typically fetched via `chainSignatures.latestKeyVersion()`
const keyVersion = 0;
