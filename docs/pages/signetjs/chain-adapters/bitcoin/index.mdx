...
```ts twoslash
import { chainAdapters } from '@sig-net/signet.js'
...
- [Unit tests](https://github.com/sig-net/signet.js/blob/main/tests/unit/btc/Bitcoin.test.ts) — single and multi-input transactions with mocked signing
- [E2E tests](https://github.com/sig-net/signet.js/blob/main/tests/e2e/btc/BTC.e2e.test.ts) — MPC signing on Sepolia, broadcast on regtest
