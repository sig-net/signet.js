...
const cosmos = new chainAdapters.Cosmos({
  chainId: 'cosmoshub-4',
...
// Cosmos Hub
const cosmosHub = new chainAdapters.Cosmos({
  chainId: 'cosmoshub-4',
  contract: evmChainSigContract,
})

// Osmosis
const osmosis = new chainAdapters.Cosmos({
  chainId: 'osmosis-1',
  contract: evmChainSigContract,
})

// Juno
const juno = new chainAdapters.Cosmos({
  chainId: 'juno-1',
  contract: evmChainSigContract,
})
```
