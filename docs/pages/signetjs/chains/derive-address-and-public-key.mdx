...
The `deriveAddressAndPublicKey` method derives an EVM address and public key from a predecessor ID and derivation path.
...
| ----------- | -------- | -------------------------------------------------------- |
| `address`   | `string` | The derived EVM address                                  |
