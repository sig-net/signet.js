...
To create your own implementation to use on the [Chain](./chain-interfaces.mdx) Instance, your contract must implement the `BaseChainSignatureContract` interface.
