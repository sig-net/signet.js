...
To create your own implementation to use on the [Chain](./chain-adapter-interface.mdx) Instance, your contract must implement the `BaseChainSignatureContract` interface.
