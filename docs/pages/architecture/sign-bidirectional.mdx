...
3. Signs the response hash using a special derivation path (`"response key"`)
...
- [Solana Program API](/contract-api/solana/instructions) - Solana instructions
- [EVM Destination Chain Guide](/contract-api/solana/destination-chains/evm) - Using sign_bidirectional with EVM destinations
