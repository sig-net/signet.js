...
> **Comprehensive Documentation**: For detailed documentation including request ID generation, serialization schemas, response verification, error handling, and security considerations, see the **[Signet Solana Program Rust Docs](https://sig-net.github.io/solana-signet-program/)**.
...
- [Signet Solana Program Rust Docs](https://sig-net.github.io/solana-signet-program/) - Complete reference (instructions, events, types, security)
